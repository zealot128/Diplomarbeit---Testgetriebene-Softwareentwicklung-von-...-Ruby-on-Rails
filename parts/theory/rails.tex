...
\begin{itemize}
 ...
 \item neben den mitgelieferten Tools das Rails\index{Ruby-on-Rails} Ökosystem eine Vielzahl von Testtools bereitstellt, u.a. Rspec (\glossar{BDD}-Testframework), Rcov (Testabdeckung), diverse Mockbibliotheken (mocha, FlexMock, RR, Rspec Mocks), Tools zum Generieren und Bereitstellen von Testdaten (Fixtures, Factories, Faker) und \glossarpl{metrik} (metric-fu)
