...
%  \url{http://en.wikipedia.org/wiki/Representational_State_Transfer}}
 \item[View\index{Ruby-on-Rails!View}] Eine View ist in der Regel ein Stück HTML-Code welches einem Model zugeordnet ist, das bei einer bestimmten Aktion dem Clienten ausgeliefert wird. Neben HTML ist auch Javascript\index{Javascript} oder XML eine mögliche Auslieferungsform.\\
...
% label{fig:df19f5}
  Damit wird das Model Job, eine Migration zur Erstellung der Datenbanktabelle "`jobs"', ein Controller\index{Ruby-on-Rails!Controller} "`jobs"' mit den REST-Standardaktionen und entsprechenden Beispielviews sowie Testfälle für Unit- und Funktionale Tests angelegt. \\
...
\begin{description}
 ...
 Es können auch damit auch gleichzeitig View\index{Ruby-on-Rails!View}-Tests unternommen werden, also z.B. die Untersuchung, ob ein bestimmtes HTML-Element auf der Web-Seite zu sehen ist.
