...
Rails ist ein Applikationsframeworks für Webanwendungen, und basiert auf dem Model-View-Controller-Pattern, welches eine 3-Schichten Architektur darstellt. Jede Schicht hat fest definierte Aufgaben. Diese bilden normalerweise ein Dreigespann, bei Rails "`Ressource"` gennannt. Im folgenden werden die Schichten kurz erläutert, und am Beispiel einer Ressource "`Job"'
\begin{description}
