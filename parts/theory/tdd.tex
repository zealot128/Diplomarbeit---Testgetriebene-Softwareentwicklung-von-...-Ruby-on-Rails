...
\end{figure}
  ...
  Ein genau spezifizierter Ablauf ist in Abbildung \ref{fig:tddflow} zu finden.
  \begin{figure}[hp]
 \centering
 \includegraphics[width=0.7\textwidth]{./diagrams/tdd-flowchart.pdf}
...
\end{figure}
  ...
  \label{sec:attd}
  Die Akzeptanztest-getriebene Entwicklung ist eine Modifikation von TDD. Statt der Unittests, stehen hier die Akzeptanztests im Vordergrund
