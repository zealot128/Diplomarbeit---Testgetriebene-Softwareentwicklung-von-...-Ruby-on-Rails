...
So zeigt eine Fallstudie, dass TDD\index{TDD} zu größerer Produktqualität bei gleichzeitigt hoher Flexibilität führt, was ebenso zu einer höheren Zufriedenheit bei den Programmiern führt \citep{hans_wasmus_evaluation_2007}.
