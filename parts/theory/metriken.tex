...
Sollte dieser deutlich kleiner als 1 sein, so ist dies ein Symptom für zu wenige Test\index{Test}s. Diese Zahl ist start von dem Testframework und dem Programmframework abhängig. Gute Projekte sollten (deutlich) mehr Testcode als Programmcode besitzen \citep[S. 238]{hunt_pragmatic_1999}.
...
\begin{description}
 ...
 Beim Messen der Abdeckung stellt sich schnell die Frage, wieviel Testabdeckung\index{Test!Testabdeckung} sinnvoll oder gar notwendig ist. Zuerst ist die Art des Messverfahrens, also C0 bis C2, wichtig. Je komplexer das Messen erfolgte, desto geringer kann die Testabdeckung am Ende ausfallen \citep{catherine_powell_abakas_2008}.
