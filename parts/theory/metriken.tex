...
Als Code-Smells werden alle Symptome innerhalb des Quelltextes bezeichnet, die Anzeichen für ein tieferes, zugrundeliegendes Problem sein können. Die Einordnung von Code-Smells variiert aber abhängig von der Programmiersprache oder Framework und ist oft subjektiv. Code-Smells werden meist automatisiert durch Werkzeuge gefunden und geben dem Programmier Hinweise für mögliche Refaktorisierungen.
