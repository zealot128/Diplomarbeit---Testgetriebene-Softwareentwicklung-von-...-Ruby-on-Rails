...
Ein weiteres Beispiel ist Beziehungen zwischen den einzelnen Modell\index{Ruby-on-Rails!Modell}en innerhalb von \glossar{rails} (ebenfalls unter der Verwendung von ActiveRecord\index{ActiveRecord}).
