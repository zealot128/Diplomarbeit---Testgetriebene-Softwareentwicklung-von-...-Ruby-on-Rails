...
\subsection{Motivation zum Testen}
...
Ziel des Komponententest ist es, verschiedene Units in Kombination als eine vollständige Komponente zu testen \citep{goodliffe_code_2006}.
 ...
 \subsection{Test Doubles -- Mocks und Stubs}
  ...
  Ein \textbf{Stub} ist eine nachahmende Funktion oder Objekt, welches die schwer zu isolierende Klasse während des Testfalls ersetzt. Im Beispiel ist dies der Bezahlprozess einer Bestellung. %TODO SyntaxHL
  \begin{lstlisting}
def test_report_failed_payment
  ...
  Hier z.B. ein Mock um einen Netzwerkzugriff zu testen und abzufangen. %TODO SyntaxHL
  \begin{lstlisting}
...
%TODO Agile Software Entwicklung? und XP irgendwo erklaeren?
