...
Die Anweisungen des Akzeptanztest\index{Akzeptanztest}s werden auf die definierten Testschritt\index{Cucumber!Testschritt}e gemappt, die Cucumber\index{Cucumber} dann sequentiell ausführt.
