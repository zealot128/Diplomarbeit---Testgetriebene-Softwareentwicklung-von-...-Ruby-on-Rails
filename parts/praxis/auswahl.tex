...
Der Vorteil dieser Outside-In-Entwicklung ist, dass sie auf den Kunden ausgerichtet ist. Die Verwendung der domänenspezifischen Sprache Cucumber\index{Cucumber} fördert zudem die Implementierung von Business-relevanten Features gemeinsam mit dem Kunden. Das gesamte Vokabular orientiert sich an der Anforderungsanalyse und an Businessprozessen, die auch der Kunde, der meist keinen technischen Hintergrund besitzt, verstehen kann.
...
Die Testabdeckung\index{Test!Testabdeckung} wird durch \textbf{simple-cov} berechnet, welches eine C0-Anweisungsüberdeckung bestimmt.
