...
Diese Validierungen werden durch das \glossar{ORM}-Framework ActiveRecord, welches Rails\index{Ruby-on-Rails} standardmäßig nutzt, bereitgestellt. Bevor wir weiter auf die 
...
Danach können wir die Rails\index{Ruby-on-Rails}-Test-Suite mithile eines weitere Rake-Tasks auch schon ausführen. Dieser Rake-Task legt selbsständig eine Testdatenbank an, führt offene Migrationen darauf aus und führt dann alle vorhanden Tests aus.
