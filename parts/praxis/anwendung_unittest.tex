...
Danach können wir die Rails\index{Ruby-on-Rails}-Test-Suite\index{Test!Test-Suite} mithilfe eines weiteren Rake\index{Ruby!Rake}-Tasks auch schon ausführen. Dieser Rake-Task legt selbständig eine Testdaten\index{Test!Testdaten}bank an, führt offene Migrationen darauf aus und führt dann alle vorhanden Tests aus.
