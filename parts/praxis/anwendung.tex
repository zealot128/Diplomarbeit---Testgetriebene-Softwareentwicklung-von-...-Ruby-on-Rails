...
Webanwendung, den Modell\index{Rails!Modell}- und Controller\index{Rails!Controller}tests. Im Dritten Abschnitt sehen wir, wie Test Doubles verwendet werden können, um Zugriffe auf externe Datenlieferanten zu simulieren. Danach betrachten wir die Anwendung aus Anwendersicht, und widmen wir uns der Implementierung von Akzeptanz\index{Test!Akzeptanztest}- und Systemtests (vgl. Abschnitt \ref{sec:acceptance}). 
