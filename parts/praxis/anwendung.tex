...
Bei IT-Jobs\index{IT-Jobs-Projekt} beschränkt sich der Einsatz von JavaScript\index{JavaScript} allerdings auf die erwähnten einfachen DOM-Manipulationen, wodurch JavaScript-Unittests nicht erforderlich waren.
