...
Nun werden automatisch alle Cucumber-Features getestet. Falls Selenium\index{Selenium} verwendet wird, dann wird der Firefox im Hintergrund gestartet, ohne dass dies sichtbar wird.
