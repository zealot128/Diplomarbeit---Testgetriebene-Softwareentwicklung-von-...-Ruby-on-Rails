...
Wie das Zusammenspiel von Ruby (on Rails\index{Ruby-on-Rails}), der Testgetriebene\index{TDD}n Entwicklung und der Einsatz von Code-Metrik\index{Code-Metrik}en praktisch erfolgen kann, wird in dieser Arbeit im Detail betrachtet und mit eigenen praktischen Erfahrungen belegt.
