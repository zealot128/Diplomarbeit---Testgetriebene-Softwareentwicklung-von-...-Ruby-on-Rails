...
Da die Testgetriebene\index{TDD} Softwareentwicklung auf dem dynamischen Unittest\index{Test!Unittest} basiert, ist das Kapitel \fullref{sec:test} dem Testen im Allgemeinen gewidmet. Danach erfolgt eine Einführung in die \textit{\nameref{sec:tdd}} im Kapitel \ref{sec:tdd}. \\
