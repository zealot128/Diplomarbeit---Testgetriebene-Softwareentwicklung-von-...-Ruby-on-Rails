...
Als Ergänzung zu den lokalspezifischen Communitys mit strenger Mitgliederauswahl soll nun ein neues, allgemeines IT-Jobportal entwickelt werden. Der vorraussichtliche Name wird IT-Jobs\index{IT-Jobs-Projekt}-Und-Stellen.de\footnote{\url{http://www.it-jobs-und-stellen.de/}} sein.
...
\begin{itemize}
 ...
 \item Ein Arbeitgeber kann eine Stellenanzeige für ein Vielfaches von 30 Tagen schalten. Damit wird ein Bezahlvorgang über ein Drittanbieterportal (z.B. PayPal) ausgelöst und bei Bestätigung die Stelle sichtbar geschaltet. Er kann dazu zwischen 5 verschiedenen Designs wählen und Logo und Bild hinzufügen.
